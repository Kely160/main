...
REM Declaration des variables
    ...
    set web=C:\Users\KEVIN\OneDrive\Bureau\Etudes\S5\S6_Framework\SprintTest2\web
    set xml=C:\Users\KEVIN\OneDrive\Bureau\Etudes\S5\S6_Framework\SprintTest2\web.xml
    set lib=C:\Users\KEVIN\OneDrive\Bureau\Etudes\S5\S6_Framework\SprintTest2\lib
    set war=.\
    set src=C:\Users\KEVIN\OneDrive\Bureau\Etudes\S5\S6_Framework\SprintTest2\src
